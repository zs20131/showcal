CREATE TABLE `TC_GRADE_WEIGHT` (
    `ID` BIGINT(20)  NOT NULL  COMMENT '主键',
    `TYPE` VARCHAR(50)  DEFAULT NULL  COMMENT '权重类型',
    `VALUE` INTEGER(20)  DEFAULT NULL  COMMENT '权重值',
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='打分权重表';