CREATE TABLE `TC_SYNC_SPORT` (
    `ID` BIGINT(20)  NOT NULL  COMMENT '主键',
    `SPORT_HEAD_ID` BIGINT(20)  DEFAULT NULL  COMMENT '执行的运动方案ID',
    `TOTAL_TIME` INTEGER(20)  DEFAULT NULL  COMMENT '本次运动总时长',
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='运动同步表)';