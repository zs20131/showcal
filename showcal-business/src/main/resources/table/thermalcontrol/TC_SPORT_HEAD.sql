CREATE TABLE `TC_SPORT_HEAD` (
    `ID` BIGINT(20)  NOT NULL  COMMENT '主键',
    `NAME` VARCHAR(100)  DEFAULT NULL  COMMENT '运动头名称',
    `TOTAL_TIME` INTEGER(20)  DEFAULT NULL  COMMENT '运动总时长',
    `INTENSITY` VARCHAR(50)  DEFAULT NULL  COMMENT '运动强度',
    `ADDRESS` VARCHAR(50)  DEFAULT NULL  COMMENT '运动地点',
    `START_BMI` DECIMAL(19,5)  DEFAULT NULL  COMMENT 'BMI起始值',
    `END_BMI` DECIMAL(19,5)  DEFAULT NULL  COMMENT 'BMI结束值',
    `IS_INJURY_JOIN` TINYINT(1)  DEFAULT NULL  COMMENT '有运动损伤是否可以参与',
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='运动方案';