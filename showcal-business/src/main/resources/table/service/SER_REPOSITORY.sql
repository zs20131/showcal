CREATE TABLE `SER_REPOSITORY` (
    `ID` BIGINT(20)  NOT NULL  COMMENT '主键',
    `TYPE` VARCHAR(50)  DEFAULT NULL  COMMENT '知识库类型',
    `TAG` VARCHAR(1000)  DEFAULT NULL  COMMENT '知识库标签',
    `KEYWORD` VARCHAR(1000)  DEFAULT NULL  COMMENT '知识库关键字',
