CREATE TABLE `SER_QUESTION` (
    `ID` BIGINT(20)  NOT NULL  COMMENT '主键',
    `TAG` VARCHAR(100)  DEFAULT NULL  COMMENT '标签',
    `KEYWORD` VARCHAR(100)  DEFAULT NULL  COMMENT '关键字',
    `RESPONSE_TIME` DATETIME  DEFAULT NULL  COMMENT '目标响应时间',
    `IS_ANSWERED` TINYINT(1)  DEFAULT NULL  COMMENT '是否已回答',
    `ANSWER_USER_ID` BIGINT(20)  DEFAULT NULL  COMMENT '回答人',
    `ANSWER_TIME` DATETIME  DEFAULT NULL  COMMENT '回答时间',
    `ANSWER_ID` BIGINT(20)  DEFAULT NULL  COMMENT '回答这个问题的答案ID',
