CREATE TABLE `PL_COMMENT_POST` (
    `ID` BIGINT(20)  NOT NULL  COMMENT '主键',
    `PARENT_ID` BIGINT(20)  DEFAULT NULL  COMMENT '父评论发布ID',
    `ROOT_ID` BIGINT(20)  DEFAULT NULL  COMMENT '根评论发布ID',
    ...
    `POST_TIME` DATETIME  DEFAULT NULL  COMMENT '评论发布时间',
    `THREAD_ID` BIGINT(20)  DEFAULT NULL  COMMENT '评论对象ID',
