CREATE TABLE `PL_INTEGRAL_DETAIL` (
    `ID` BIGINT(20)  NOT NULL  COMMENT '主键',
    `USER_ID` BIGINT(20)  DEFAULT NULL  COMMENT '用户ID',
    `STATUS` INTEGER(20)  DEFAULT NULL  COMMENT '积分状态(增加或者消费积分)',
    `INTEGRAL_TIME` DATETIME  DEFAULT NULL  COMMENT '积分时间',
    `CONTENT` VARCHAR(1000)  DEFAULT NULL  COMMENT '积分内容',
    `RULE_ID` BIGINT(20)  DEFAULT NULL  COMMENT '积分规则ID',
    `VALUE` INTEGER(20)  DEFAULT NULL  COMMENT '当次积分值',
