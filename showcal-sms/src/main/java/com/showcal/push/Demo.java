package com.showcal.push;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.showcal.push.android.*;
import com.showcal.push.ios.*;


public class Demo {
    private String appkey = "5617440567e58ecd3000048b";
    private String appMasterSecret = "ctjiy0dqaepsuhzerp3gayxbtxg6g4bu";
    ...
    public void sendAndroidBroadcast() throws Exception {
        ...
        broadcast.setPredefinedKeyValue("title", "瘦咖");
        broadcast.setPredefinedKeyValue("text", "瘦咖广播测试");
    ...
    public void sendAndroidCustomizedcast() throws Exception {
        ...
        customizedcast.setPredefinedKeyValue("alias", "651571872873713664,648848943144636416");
        // TODO Set your alias_type here
        customizedcast.setPredefinedKeyValue("alias_type", "SHOWCAL");
        customizedcast.setPredefinedKeyValue("ticker", "Android customizedcast ticker");
        customizedcast.setPredefinedKeyValue("title", "瘦咖精准推送");
        customizedcast.setPredefinedKeyValue("text", "惺惺惜惺惺");
    ...
    public void sendIOSCustomizedcast() throws Exception {
        ...
        // And if you have many alias, you can also upload a file containing these alias, then
        // use file_id to send customized notification.
        customizedcast.setPredefinedKeyValue("alias", "648671138192691200");
        // TODO Set your alias_type here
        customizedcast.setPredefinedKeyValue("alias_type", "SHOWCAL");
        customizedcast.setPredefinedKeyValue("alert", "IOS 个性化测试");
//        customizedcast.setPredefinedKeyValue("body", "IOS 个性化测试");
//        customizedcast.setPredefinedKeyValue("key1", "测试消息");
    ...
    public static void main(String[] args) {
        ...
        Demo demo = new Demo("5617440567e58ecd3000048b", "ctjiy0dqaepsuhzerp3gayxbtxg6g4bu");
        try {
