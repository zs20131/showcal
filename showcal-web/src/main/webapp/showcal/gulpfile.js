...
var demoName="showcal";

//css
var bootstrapCssVersion="1.0.0";
var fontVersion="1.0.8";
var showcalfontVersion = "1.0.1";
var xnStyleCommonVersion="1.1.14";
...
var buildGlobalFiles=[
    ...
    "./spm_modules/xn-markdown-setting/" + xnMarkDownSetting + "/directive/markdown.js",
...
var buildGlobalCssFiles=[
    ...
    "./spm_modules/xn-directive-loading/"+xnDirectiveLoadingVersion+"/directive/style.css",
     "./spm_modules/xn-markdown-setting/" + xnMarkDownSetting + "/style/thinker.min.css",
...
// 定义develop任务在日常开发中使用
gulp.task("dev",["build-local-js","build-local-less","copy-css-images","copy-font","copy-xn-icon","copy-cookies-map"],function(){
    console.log("运行完成dev");
});
