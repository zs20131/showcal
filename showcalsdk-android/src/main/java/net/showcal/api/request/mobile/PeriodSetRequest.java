...
import net.showcal.api.response.mobile.PeriodSetResponse;
 ...
 * </pre>
 */
public class PeriodSetRequest implements XiniuRequest<PeriodSetResponse> {
    ...
    public Class getResponseClass() {
        return PeriodSetResponse.class;
    }
