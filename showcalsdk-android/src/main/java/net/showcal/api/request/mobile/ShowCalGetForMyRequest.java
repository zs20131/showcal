...
import net.showcal.api.response.mobile.ShowCalGetForMyResponse;
 ...
 * </pre>
 */
public class ShowCalGetForMyRequest implements XiniuRequest<ShowCalGetForMyResponse> {
    ...
    public Class getResponseClass() {
        return ShowCalGetForMyResponse.class;
    }
