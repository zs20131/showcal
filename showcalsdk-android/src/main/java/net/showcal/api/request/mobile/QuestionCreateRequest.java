...
import net.showcal.api.response.mobile.QuestionCreateResponse;
 ...
 * </pre>
 */
public class QuestionCreateRequest implements XiniuRequest<QuestionCreateResponse> {
    ...
    public Class getResponseClass() {
        return QuestionCreateResponse.class;
    }
