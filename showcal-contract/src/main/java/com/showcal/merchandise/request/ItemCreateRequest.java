...
import com.showcal.merchandise.response.ItemDetailCreateResponse;
 ...
 * @author 顾志雄
 */
public class ItemCreateRequest extends BaseRequest {
    /**
     * 主键
     */
     ...
     * 物料详情
     */
    private ItemDetailCreateRequest itemDetailCreateRequest;
    /**
     * 物料属性
     */
    private ItemEcommerceCreateRequest itemEcommerceCreateRequest;
    /**
     * 物料图片
     */
    private List<ItemPictureCreateRequest> itemPictureCreateRequest;
    ...
    public ItemDetailCreateRequest getItemDetailCreateRequest() {
        return itemDetailCreateRequest;
    }

    public void setItemDetailCreateRequest(ItemDetailCreateRequest itemDetailCreateRequest) {
        this.itemDetailCreateRequest = itemDetailCreateRequest;
    }

    public ItemEcommerceCreateRequest getItemEcommerceCreateRequest() {
        return itemEcommerceCreateRequest;
    }

    public void setItemEcommerceCreateRequest(ItemEcommerceCreateRequest itemEcommerceCreateRequest) {
        this.itemEcommerceCreateRequest = itemEcommerceCreateRequest;
    }

    public List<ItemPictureCreateRequest> getItemPictureCreateRequest() {
        return itemPictureCreateRequest;
    }

    public void setItemPictureCreateRequest(List<ItemPictureCreateRequest> itemPictureCreateRequest) {
        this.itemPictureCreateRequest = itemPictureCreateRequest;
    }
