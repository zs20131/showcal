/**
 * @(#)SettingUserTagUpdateRequest.java
 *
 ...
 * @author 顾志雄
 */
public class SettingUserTagUpdateRequest extends BaseUpdateRequest {
    ...
    @Length(min=1, max=50, message = "标签名称长度不合法")
    private  String   tag;
    ...
    @Length(min=0, max=50, message = "标签RGB颜色长度不合法")
    ...
    @Length(min=0, max=50, message = "备注长度不合法")
