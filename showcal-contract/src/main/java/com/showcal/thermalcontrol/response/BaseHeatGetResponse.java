 ...
 * @author 顾志雄
 */
public class BaseHeatGetResponse extends BaseResponse {

    /**
     * 基础热量设置信息
     */
    private BaseHeat baseHeat;

    public BaseHeat getBaseHeat() {
        return this.baseHeat;
    }

    public void setBaseHeat(BaseHeat baseHeat) {
